...
def login_page():
        ...
        l_username = Label(window, text="User Name", padx=40, pady=20, bg="dark violet",
        fg="black", width=2, height=4)
        en_username = Entry(window, width=30, borderwidth=5, bg="white",
        fg="black")
        l_username.grid(column=1, row=1)
        en_username.grid(column=2, row=1)

        l_username1 = Label(window, text="Password", padx=40, pady=20, bg="blue violet",
        fg="black", width=2, height=4)
